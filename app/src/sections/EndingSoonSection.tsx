...
export function EndingSoonSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-screen py-12 md:py-16 lg:py-0 lg:h-screen overflow-hidden bg-charcoal-light flex items-center justify-center"
    >
      <div className="w-full px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 max-w-6xl mx-auto gap-4">
          <h2
            ref={titleRef}
            className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white tracking-[0.02em] relative"
          >
        ...
        >
          {endingSoonCars.map((car) => (
            ...
            >
              <div className="bg-charcoal rounded-2xl overflow-hidden border border-white/[0.06] card-shadow hover-lift">
                {/* Image */}
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-white/50 mb-0.5">Current bid</p>
        ...
        <div ref={ctaRef} className="text-center mt-10">
          <Button
            variant="outline"
            className="border-white/20 text-white hover:bg-white/5 rounded-xl px-8 group/btn relative overflow-hidden"
            onMouseEnter={(e) => {
